...
public enum ApiKeys {
    ...
    BROKER_HEARTBEAT(50, "BrokerHeartbeat", BrokerHeartbeatRequestData.SCHEMAS,
            BrokerHeartbeatResponseData.SCHEMAS),
    CONTROLLER_HEARTBEAT(51, "ControllerHeartbeat", ControllerHeartbeatRequestData.SCHEMAS,
